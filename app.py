...
def scan_next_brand():
    ...
    Call this repeatedly to scan all brands without timeout.
    
    Returns which brand was scanned and what was found.
    """
    try:
        max_influencers = request.args.get('max_influencers', 100, type=int)
        pages = request.args.get('pages', 3, type=int)
        ...
        return jsonify({
            ...
            'message': f'Scanned {brand.seller_name}: {new_products} new, {updated_products} updated'
        })
    ...
    try:
        ...
        response = requests.get(
            ...
            params={
                ...
                'page_num': 1,
                'page_size': 10,
                'seller_product_sort_field': 4,  # GMV
                'sort_type': 1,
            },
            auth=auth,
            timeout=30
