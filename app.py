...
- Scan their products sorted by TOTAL SALES DESCENDING
...
- Note: NO influencer sort option for products - must filter after fetch
"""
    ...
    try:
        response = requests.get(
            ...
            params={
                ...
                "page_num": page,
                "page_size": page_size,
                "seller_product_sort_field": 1,  # Total Sales
                "sort_type": 1                    # Descending
            },
            auth=get_auth(),
            timeout=30
...
def scan_top_brands():
    ...
    results = {
        ...
        'filter_settings': {
            ...
            'min_sales': min_sales,
            'sort': 'total_sales_descending',
            'note': 'Products sorted by sales, filtered by influencer count'
        }
    }
